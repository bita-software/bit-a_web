...
export interface Post {
  ...
  title: string;
  /**
   * Resumen ejecutivo de 2 o 3 líneas que ataque directamente el beneficio (Lead Magnet).
   */
  excerpt: string;
  /**
  ...
  readingTime: number;
  /**
   * Nivel estratégico del contenido.
   */
  visionLevel: 'foundation' | 'c-level' | 'business';
  slug: string;
